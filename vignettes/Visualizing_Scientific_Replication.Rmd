...
vignette: >
  %\VignetteIndexEntry{Visualizing Scientific Replication}
...
The difference mode uses a set of four symbol that were chosen to be semantically close to the scenarios that they are encoding, i.e. "unobserved" is "$\times$", "different" is "$\neq$", and "incorrect" is "$!$". The least informative scenario in which both studies are the same is de-emphasized. 
