...
In this vignette, we will demonstrate how to use the functions in this package and recreate the main figure in [@patil2016statistical]. Note that 
we use the flag "rmk = T" when calling the sci_figure function to properly render the figures in rmarkdown. This is not 
necessary when using this package in the UI.
